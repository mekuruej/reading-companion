...
export default function BookCategoryFilterSelector({
  filters,
  value,
  onChange,
  bookCount,
}: {
  filters: BookCategoryFilterOption[];
  value: string;
    ...
    <>
      ...
      {typeof bookCount === "number" ? (
        <p className="mt-3 text-xs text-slate-500">
          ...
          book{bookCount === 1 ? "" : "s"} with vocabulary data included in this
          category.
        </p>
      ) : null}
    </>
