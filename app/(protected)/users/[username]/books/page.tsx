  ...
  return (
    <main className="min-h-screen bg-slate-100 text-slate-950">
      <section className="mx-auto flex min-h-screen w-full max-w-6xl flex-col px-6 py-8 sm:px-8 lg:px-10">
        ...
        <section className="flex flex-1 flex-col justify-between gap-10 pt-14 sm:pt-20">
          <div className="max-w-4xl">
            ...
            <h2 className="max-w-4xl text-5xl font-black leading-[1.05] tracking-tight text-slate-950 sm:text-6xl lg:text-7xl">
              Read more deeply.
              <br />
              Talk more naturally.
              <br />
          ...
          <div className="grid gap-4 pb-2 md:grid-cols-3">
            ...
            <Link
              href="/dashboard"
              className="group flex min-h-[210px] flex-col justify-between rounded-[1.75rem] border border-slate-600 bg-slate-800 p-6 text-white shadow-md transition hover:-translate-y-1 hover:bg-slate-900 hover:shadow-xl"
            >
              <div>
                ...
                <h3 className="mt-3 text-2xl font-black leading-tight">
                  Open the MEKURU reading app
                </h3>
                <p className="mt-3 text-sm leading-6 text-slate-100">
                  Current students can track books, save vocabulary, review
                  words, and continue their reading practice.
                </p>
              </div>
