...
import AbilityCheckFeedbackPanel from "./components/AbilityCheckFeedbackPanel";
import AbilityCheckModeStatusPanel from "./components/AbilityCheckModeStatusPanel";
    ...
    <main className="min-h-screen flex flex-col items-center bg-slate-100 px-4 py-4 sm:px-6">
      ...
      <div className="mb-2 w-full max-w-3xl space-y-2">
        ...
        <AbilityCheckModeStatusPanel
          ...
          dailyLevelsLabel={
            dailyCheckPlan ? dailyCheckLevelsLabel(dailyCheckPlan.levels) : "Not started"
          }
          selectedJlpt={selectedJlpt}
          practiceColorFilter={practiceColorFilter}
          practiceStudyMode={practiceStudyMode}
          onSelectedJlptChange={setSelectedJlpt}
          onPracticeColorFilterChange={(value) =>
