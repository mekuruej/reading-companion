type AbilityCheckFullAccessLockedStateProps = {
  title: string;
  message: string;
...
export default function AbilityCheckFullAccessLockedState({
  title,
  message,
  onBackToLibrary,
  onViewStats,
}: AbilityCheckFullAccessLockedStateProps) {
  return (
    <main className="min-h-screen bg-slate-100 px-3 py-4 sm:px-6 sm:py-8">
      <div className="mx-auto max-w-3xl">
        <div className="rounded-3xl border border-stone-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-3 text-sm leading-6 text-stone-600">
            Your saved vocabulary and color progress are kept safe. Ability Check is
