      ...
      <div className="mx-auto max-w-4xl">
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 text-slate-400">
              <div className="text-sm font-black">Ability Check Test Helper</div>
              <p className="mt-2 text-sm leading-6">
                Coming later: due cards, color counts, and test-card creation helpers.
              </p>
            </div>
          </div>
        </div>
