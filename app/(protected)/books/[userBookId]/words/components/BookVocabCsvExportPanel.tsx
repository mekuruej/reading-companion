...
type BookVocabCsvExportPanelProps = {
  ...
  wordCount: number;
  onExportCsv: (chapterValue: string) => void;
};
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-xs text-stone-600">
            Choose a chapter or export all chapters. CSV files can be opened in spreadsheet apps.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2 sm:min-w-72 sm:flex-row sm:items-center">
          ...
          <button
            ...
            onClick={() => onExportCsv(exportChapter)}
