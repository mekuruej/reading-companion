...
type CuriosityRecentSessionWordCardProps = {
  word: CuriosityRecentSessionWord;
...
export default function CuriosityRecentSessionWordCard({
  word,
  colorInfo,
  ...
  onEdit,
  onDelete,
}: CuriosityRecentSessionWordCardProps) {
  return (
