...
export default function SingleAddPage() {
    ...
    async function saveQuickWord() {
        ...
        const payload = {
            ...
            meaning_choice_index: quickPreview.isCustomMeaning ? null : quickPreview.selectedMeaningIndex,
        ...
        const { data, error } = await supabase
            ...
            .insert(payload)
            .select("id, surface, reading, meaning, page_number, chapter_number, chapter_name")
            .single();
    ...
    async function saveReadingSession() {
        ...
        const mode: "curiosity" | "fluid" = "curiosity";
            ...
            <div className="mx-auto max-w-5xl">
                <div className="mb-4 rounded-2xl border border-stone-300 bg-stone-50 p-4">
                    ...
                    <p className="mt-2 text-sm text-stone-700">
                        A reader who cannot help stopping to look up words, grammar, and anything else they find interesting.
                    </p>
                </div>
                ...
                {message ? (
                    <div className="mb-4">
                        <p className={`text-base font-medium ${message.startsWith("❌") ? "text-red-700" : "text-green-700"}`}>
                            {message}
                        </p>
                    </div>
                ) : null}
                ...
                <div className="mb-6 rounded-2xl border border-stone-300 bg-white p-4">
                    ...
                    <p className="text-sm text-stone-500">
                        Use the timer while you read, add vocab, and save your curiosity reading session to the Reading tab.
                    </p>
                    ...
                    {showTimedSessionForm && !isRunning ? (
                        <div className="mt-4 rounded-2xl border border-stone-300 bg-stone-50 p-4">
                            <div className="mb-3 text-sm font-medium text-stone-700">Save this reading session</div>
