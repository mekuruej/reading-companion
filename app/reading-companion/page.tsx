...
export default function ReadingCompanionPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-100 px-6 py-12 text-slate-950">
      <div
        aria-hidden="true"
      ...
      <section className="relative z-10 mx-auto max-w-3xl rounded-3xl border border-slate-300 bg-white/90 p-8 shadow-xl shadow-slate-300/40">
